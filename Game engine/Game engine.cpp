...
public:
    ...
    bool OnUserUpdate(float fElapsedTime) override
    {
        ...
        for (auto tri : meshCube.tris)
        {
            ...
            MultiplyMatrixVector(tri.p[0], triProject.p[0], matProj);
            MultiplyMatrixVector(tri.p[1], triProject.p[1], matProj);
            MultiplyMatrixVector(tri.p[2], triProject.p[2], matProj);
